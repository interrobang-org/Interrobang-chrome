...
var Button = styled_components_1.default.p(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  cursor: pointer;\n  font-size: 16px;\n  outline: none;\n  text-decoration: underline;\n\n  &:hover {\n    color: #2828bd;\n  }\n"], ["\n  cursor: pointer;\n  font-size: 16px;\n  outline: none;\n  text-decoration: underline;\n\n  &:hover {\n    color: #2828bd;\n  }\n"])));
var ResultGroup = styled_components_1.default.div(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  color: #545454;\n  display: flex;\n  justify-content: space-between;\n  margin-top: 32px;\n  width: 100%;\n\n  > div {\n    width: 48%;\n  }\n"], ["\n  color: #545454;\n  display: flex;\n  justify-content: space-between;\n  margin-top: 32px;\n  width: 100%;\n\n  > div {\n    width: 48%;\n  }\n"])));
...
var ResultBox = styled_components_1.default.div(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  background-color: #f7f7f7;\n  border-radius: 3px;\n  font-size: 13px;\n  height: 140px;\n  margin-top: 9px;\n  padding: 5px 6px;\n"], ["\n  background-color: #f7f7f7;\n  border-radius: 3px;\n  font-size: 13px;\n  height: 140px;\n  margin-top: 9px;\n  padding: 5px 6px;\n"])));
var Credit = styled_components_1.default.div(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  color: gray;\n  margin-top: 20px;\n\n  span {\n    margin-right: 12px;\n    \n  }\n\n  a {\n    text-decoration: none;\n  }\n"], ["\n  color: gray;\n  margin-top: 20px;\n\n  span {\n    margin-right: 12px;\n    \n  }\n\n  a {\n    text-decoration: none;\n  }\n"])));
var Root = function () {
    var _a = react_1.useState(textareaPlaceholder), text = _a[0], setText = _a[1];
    ...
    return (react_1.default.createElement(StyledRoot, null,
        ...
        react_1.default.createElement(Wrapper, null,
            ...
            react_1.default.createElement(ResultGroup, null,
                react_1.default.createElement(Result, { label: "blabla", title: 'Summary' }),
                react_1.default.createElement(Result, { label: "fwle", title: 'Questions' })),
