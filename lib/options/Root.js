...
var Root = function () {
    ...
    var _d = react_1.useState('[question]'), question = _d[0], setQuestion = _d[1];
    var handleClickConvert = react_1.useMemo(function () { return function (e) {
        ...
        var p2 = postData(Endpoint.questions, {
            text: text,
            summarize: 1,
            url: 'none',
        });
    ...
    return (react_1.default.createElement(StyledRoot, null,
        ...
        react_1.default.createElement(Wrapper, null,
            ...
            react_1.default.createElement(ResultGroup, null,
                ...
                react_1.default.createElement(Result, { label: question, title: 'Questions' })),
